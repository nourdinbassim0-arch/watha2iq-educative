...
export const ExportModal: React.FC<ExportModalProps> = ({
  ...
  const formatsList: { id: ExportFormat; title: string; description: string; icon: any; badge: string; color: string }[] = [
    {
      id: 'pdf',
      title: 'مستند PDF للطباعة والمشاركة (PDF)',
      description: 'ملف PDF رسمي فائق الجودة متوافق 100% مع الطابعات ومطابق للتنسيق والترويسة المغربية.',
      icon: FileText,
    ...
    {
      id: 'png',
      title: 'صورة رقمية فائقة الدقة (PNG)',
      description: 'صورة نقية وعالية الوضوح (2x DPI) مناسبة للحفظ والمشاركة الرقمية عبر واتساب والمجموعات.',
      icon: ImageIcon,
      badge: 'دقة فائقة 2x',
      color: 'amber',
    },
    {
      id: 'jpg',
      title: 'صورة قياسية خفيفة (JPG)',
      description: 'صورة مضغوطة بحجم خفيف جداً ملائمة للإرسال السريع والمرفقات.',
      icon: ImageIcon,
      badge: 'حجم خفيف',
      color: 'orange',
    },
